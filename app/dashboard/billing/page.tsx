          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            {stripeError && (
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg text-amber-300 text-sm">
                Could not load payment details from Stripe. Your subscription status below reflects our records — contact support if something looks wrong.
              </div>
            )}
            ...
            <div className="bg-gradient-to-br from-primary-700/30 to-primary-800/30 border border-accent-500/10 rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-display text-neutral-0">Subscription Status</h2>
              ...
              {subscription ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    ...
                    <p className="font-heading text-neutral-0">MinbarAI Pro</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-sm text-neutral-400">Price</p>
                    <p className="font-heading text-neutral-0 flex items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-heading text-neutral-0">
                      Test Environment
                    </p>
                  </div>
                </div>
            ...
            {subscription && userData.subscription_status === 'active' && !userData.subscription_id?.startsWith('sub_test_') && (
              <div className="bg-gradient-to-br from-primary-700/30 to-primary-800/30 border border-accent-500/10 rounded-xl p-6">
                <h3 className="text-xl font-display text-neutral-0 mb-4">Manage Subscription</h3>
            ...
            {userData.subscription_id?.startsWith('sub_test_') && (
              <div className="bg-gradient-to-br from-primary-700/30 to-primary-800/30 border border-accent-500/10 rounded-xl p-6">
                <h3 className="text-xl font-display text-neutral-0 mb-4">Test Environment</h3>
            ...
            {invoices.length > 0 && (
              <div className="bg-gradient-to-br from-primary-700/30 to-primary-800/30 border border-accent-500/10 rounded-xl p-6">
                <h3 className="text-xl font-display text-neutral-0 mb-6">Billing History</h3>
                <div className="overflow-x-auto custom-scrollbar">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-accent-500/20">
                        <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wider text-neutral-300">Date</th>
                        <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wider text-neutral-300">Description</th>
                        <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wider text-neutral-300">Amount</th>
                        <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wider text-neutral-300">Status</th>
                        <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wider text-neutral-300">Invoice</th>
                      </tr>
                    </thead>
                    <tbody>
                      {invoices.map((invoice) => (
                        <tr key={invoice.id} className="border-b border-accent-500/10">
                          <td className="py-3 px-4 text-neutral-0">
                            {formatDate(invoice.created)}
                          </td>
                          <td className="py-3 px-4 text-neutral-0">
                            {invoice.description || 'MinbarAI Pro Subscription'}
                          </td>
                          <td className="py-3 px-4 text-neutral-0 font-heading">
