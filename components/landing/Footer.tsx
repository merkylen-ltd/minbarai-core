...
const LogoIcon: React.FC<{ className?: string }> = ({ className }) => {
  return (
    ...
    >
      <defs>
        <linearGradient id="footerFaceFront" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="currentColor" stopOpacity="1"/>
          <stop offset="100%" stopColor="currentColor" stopOpacity="0.8"/>
        </linearGradient>
        <linearGradient id="footerFaceSide" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="currentColor" stopOpacity="0.7"/>
          <stop offset="100%" stopColor="currentColor" stopOpacity="0.5"/>
        </linearGradient>
        <linearGradient id="footerFaceTop" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Front face */}
      <polygon points="128,160 128,384 256,448 256,224" fill="url(#footerFaceFront)"/>

      {/* Side face */}
      <polygon points="256,224 256,448 384,384 384,160" fill="url(#footerFaceSide)"/>

      {/* Top face */}
      <polygon points="128,160 256,224 384,160 256,96" fill="url(#footerFaceTop)"/>
    </svg>
  );
};
    ...
    <footer className="bg-primary-900 border-t border-primary-700/20 py-12">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Product */}
          <div>
            <h3 className="text-neutral-0 font-heading mb-4">Product</h3>
            <ul className="space-y-2">
              <li>
                <Link href="#features" className="text-neutral-300 hover:text-neutral-0 transition-colors text-sm min-h-[44px] md:min-h-0 flex items-center">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/auth/signin" className="text-neutral-300 hover:text-neutral-0 transition-colors text-sm min-h-[44px] md:min-h-0 flex items-center">
                  Sign In
                </Link>
              </li>
            </ul>
